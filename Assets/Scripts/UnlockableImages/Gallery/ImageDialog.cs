...
public class ImageDialog : MonoBehaviour
{
    ...
    {
        YandexManager.Instance.WatchRewardedVideo(UnlockImage);
    }

    private void UnlockImage()
    {
        GameAnalyticsSDK.GameAnalytics.NewAdEvent(GameAnalyticsSDK.GAAdAction.Show, GameAnalyticsSDK.GAAdType.RewardedVideo, "Yandex", "CompleteImageRewarded");
