...
public class NextLevelButton : MonoBehaviour
{
    ...
    private void HandleClick()
    {
        ...
        {
            UnlockableImageInventoryData imageData = _imageInventory.GetNextImageToShow();
            _panel.Show();
            _panel.AddProgress(imageData, imageData.Progress - imageData.Level.AmountToIncreaseProgress, imageData.Progress, () => StartCoroutine(ShowImageCoroutine()));
        }
        else
        {
